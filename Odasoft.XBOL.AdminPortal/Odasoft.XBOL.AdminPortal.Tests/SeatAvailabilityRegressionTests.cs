...
public sealed class SeatAvailabilityRegressionTests
{
    ...
    public void Availability_sell_matches_catalog_bundle_sellability()
    {
        ...
        Assert.Contains("AdminPermissions.Orders.OverrideSaleWindow", source, StringComparison.Ordinal);
        Assert.Contains("_canOverrideSaleWindow", source, StringComparison.Ordinal);
